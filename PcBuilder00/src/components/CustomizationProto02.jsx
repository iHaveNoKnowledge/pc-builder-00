...
import { removeProduct, incAmount, decAmount, updateSummations, setMax } from "../slices/customizeSliceNoApi";
...
const CustomizationProto02 = () => {
  ...
  const handleChange = (category) => {
    ...
    dispatch(setDefault());
    if (currentCategory !== category.toLowerCase().replace(" ", "")) dispatch(clearSelectedFilter());
  };
                                  ...
                                  >
                                    ...
                                    <Box sx={{ flexGrow: "1", width: "55px" }}>
                                      <Box>
                                        ...
                                        >
                                          {miniItem.img ? (
                                            ...
                                            <Box
                                              component="img"
                                              src={`/images/${miniItem.compatible.toLowerCase().split(" ", 1)}.jpg`}
                                              alt={miniItem.title}
                                              sx={{ objectFit: "contain", width: 40, height: 40 }}
                                            />
                                          )}
                                      ...
                                      >
                                        ...
                                        {/* จำนวนสินค้า */}
                                        <Box style={{ marginTop: "2px" }}>{miniItem.selectAmount}</Box>
                                    ...
                                    <Box sx={{ flexGrow: "7", width: "40px" }}>
                                      ...
                                      <Typography variant="subtitle1" sx={{ marginLeft: "70%" }}>
                                        ฿ {(miniItem.promotionPrice * miniItem.selectAmount).toLocaleString()}
                                      </Typography>
                                    </Box>
                                  </Box>
